...
<head>
 ...
 <div class="blog-details-area pt-1 pb-90">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="blog-details-wrap">
                            <div class="blog-details-img mb-40">
                                <img src="<?php echo base_url('themes/daxone/assets/images/blog/ban3.png')?>" alt="blog">
                            </div>
                                <div class="col-xl-12 col-lg-20">
                                    <div class="blog-details-content">
                                        <p class="mb-35">Sebagai satu-satunya situs yang murni menerapkan sistem lelang secara online kami ingin membantu Anda memperoleh penawaran terbaik dari setiap barang yang dilelang di Lelangkah. Beberapa hal yang bersifat kompleks dalam lelang secara offline telah kami persiapkan dengan sangat matang sehingga dapat menyuguhkan kemudahan dalam berbagai fitur yang dapat Anda akses secara online dan tentu saja akan terus kami update secara berkala.</p>
                                        <p>Aplikasi ini dibuat untuk menjualkan barang-barang seni seperti LUKISAN, SENI KRIYA, GRAFIS , serta UKIRAN yang dimana kami merangkul para kolektor atau seniman untuk mengekspresikan ke kreativitas nya di Lelangkah. </p>
                                        <blockquote>
                                            <img src="<?php echo base_url('themes/daxone/assets/images/icon-img/blockquote.png')?>" alt="blog">
                                            <h3>Ikut Lelang Barang Seni Kualitas Baik Di Lelangkah .</h3>
                                        </blockquote>
                                        <p>Lelangkah tetap memberikan jaminan keamana serta proses transaksi. Dan memberikan sepenuhnya kemudahan akses sistem ini untuk memudahkan kegiatan pelelangan</p>
                                    </div>
                                </div>
                            </div>
