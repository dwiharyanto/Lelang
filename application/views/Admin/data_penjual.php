    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Data Penjual</h4>
                    </div>
                </div>
                <div class="panel panel-body">

<?php if($this->session->flashdata('hapuspenjual') == TRUE): ?>
                                                    <div role="alert" class="alert alert-success alert-dismissable fade in">
                                                        <button aria-label="close" data-dismiss="alert" class="close" type="button"> <span aria-hidden="true" class="fa fa-times"></span></button>
                                                        <p><?php echo $this->session->flashdata('hapuspenjual')?></p>
                                                    </div>
                                                <?php endif; ?>
                    ...
                    <table class="table table-bordered table-striped" id="datatables">
                        ...
                        <tbody>
                         ...
                         <?php foreach($penjual->result() as $i=>$k){ ?>
                          <tr>
                              <td><?php echo $i+1; ?></td>
                              <td><?php echo $k->namapenjual; ?></td>
                              <td><?php echo $k->alamat; ?></td>
                              <td><?php echo $k->email; ?></td>
                              <td><?php echo $k->telp; ?></td>
                              <td class="hapus">
                                  <a href="<?php echo base_url('Admin/hapus_penjual/'.$k->idpenjual);?>"><i class=" md-highlight-remove"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
