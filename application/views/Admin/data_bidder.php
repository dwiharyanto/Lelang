    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Data Bidder</h4>
                    </div>
                </div>
                <div class="panel panel-body">
                    <table class="table table-bordered table-striped" id="datatables">
                        ...
                        <tbody>
                         ...
                         <?php foreach($bidder->result() as $i=>$k){ ?>
                          <tr>
                              <td><?php echo $i+1; ?></td>
                              ...
                              <td><?php echo $k->telp; ?></td>
                               <td class="hapus">
                                  <a href="<?php echo base_url('Admin/hapus_bidder/'.$k->idbidder);?>"><i class=" md-highlight-remove"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
