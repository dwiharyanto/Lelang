                ...
                <div class="jumbotron" style="background-color: white">
                    <div class="container">
                        ...
                        <h2><center>DATA USER</h2>
                            <br>
                            <tr class="active">
                                <td><pre>Username     : <?= $penjual['username']; ?></pre></td>
                            </tr>
                            <tr class="active">
                                <td><pre>Nama Lengkap : <?= $penjual['namapenjual']; ?></pre></td>
                            </tr>
                            <tr class="active">
                                <td><pre>Alamat       : <?= $penjual['alamat']; ?></pre></td>
                            </tr>
                            <tr class="active">
                                <td><pre>Email        : <?= $penjual['email']; ?></pre></td>
                            </tr>
                            <tr class="active">
                                <td><pre>Telp         : <?= $penjual['telp']; ?></pre></td>
                            </tr>
                            <br>
                         ...
                         <?php echo form_open_multipart('Penjual/editprofil');?>
                                        <div class="modal-body"> 
                                            <div class="row"> 
                                                <div class="col-md-6"> 
                                                    <div class="form-group"> 
                                                        <label for="username" class="control-label">Username</label> 
                                                         <input type="hidden" name="idpenjual" value="<?= $penjual['idpenjual']; ?>">
                                                        <input type="text" class="form-control" name="username" id="username" placeholder="" value="<?= $penjual['username']; ?>"> 
                                                    </div> 
                                                </div> 
                                               <!--  <div class="col-md-6"> 
                                                    <div class="form-group"> 
                                                  ...
                                                  <div class="col-md-6"> 
                                                    <div class="form-group"> 
                                                        <label for="namapenjual" class="control-label">Nama Lengkap</label> 
                                                        <input type="hidden" name="namapenjual" value="<?= $penjual['namapenjual']; ?>"> 
                                                        <input type="text" class="form-control" id="namapenjual" placeholder="" value="<?= $penjual['namapenjual']; ?>" disabled>
                                                    </div> 
                                                </div> 
                                            </div> 
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-12"> 
                                                    <div class="form-group"> 
                                                        ...
                                                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="" value="<?= $penjual['alamat']; ?>"> 
                                                    </div> 
                                                </div> 
                                            </div> 
                                             <div class="row"> 
                                                <div class="col-md-12"> 
                                                    <div class="form-group"> 
                                                        ...
                                                        <input type="email" class="form-control" id="email" placeholder="" name="email" value="<?= $penjual['email']; ?>"> <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
                                                    </div> 
                                                </div> 
                                            </div> 
                                            <div class="row"> 
                                                <div class="col-md-4"> 
                                                    <div class="form-group"> 
                                                        ...
                                                        <input type="text" class="form-control" id="telp" name="telp" placeholder="" value="<?= $penjual['telp']; ?>">  
                                                    </div> 
                                                </div> 
                                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="modal fade" id="modal-foto">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            <?php echo form_open_multipart('Penjual/doupload');?>
                                            <div class="modal-header">
